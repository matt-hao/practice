package com.blog.user.proxy;

import com.blog.user.facade.ActionFacade;
import com.blog.user.util.*;
 ...
 */
public class BlogUserProxyImpl implements BlogUserProxy {

    private static final Logger logger = Logger.getLogger(BlogUserProxyImpl.class);
